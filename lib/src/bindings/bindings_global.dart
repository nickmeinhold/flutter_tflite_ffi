...
// There is an issue with ffigen, causing the enum to be erased and turned into
// an int so we use a typedef for now and will replace it with the correct
// generated enum when the problem in ffigen has been resolved.
...
final DynamicLibrary _dylib = () {
  if (Platform.environment.containsKey('FLUTTER_TEST')) {
    ...
    if (!Platform.isMacOS) {
      throw Exception(
          'Tests currently use $testLibPath and check for FLUTTER_TEST '
